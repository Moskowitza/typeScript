...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"part5.ts":[function(require,module,exports) {
...
var CSNY = new SuperGroup('CSNY', 'Crosby, Stills, Nash and Young', 'MegaDeath');
console.log(CSNY.groupName);
/*group Name is private */

console.log(CSNY.altName);
/*alt Name is public, so no error */

console.log(CSNY.rockout());
console.log(CSNY.sayAltName());
CSNY.altName = 'Just Crosby, Stills, Nash. Screw Neil!';
console.log(CSNY.sayAltName());
CSNY.secret = 'Deathly Cow Hearders';
/* ERROR , secret is read only */
...
function (_super) {
  ...
  function Singer(name, bandName, position) {
    var _this = _super.call(this, name, bandName) || this;
  ...
  Singer.prototype.welcome = function () {
    return "Hello Cleveland! It's me, " + this.name.toUpperCase() + "! The " + this.position + " for " + this.bandName + "."; // Private!
  };

  return Singer;
}(BandMember);

var davidLeeRoth = new Singer('David Lee Roth', 'Van Halen', 'FrontMan');
...
},{}]},{},["../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","part5.ts"], null)
//# sourceMappingURL=/part5.977f9de3.js.map